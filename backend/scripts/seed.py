...
SEED_DISCUSSIONS = [
    {
        ...
        "panelists": [
            ...
            {"id": "seed-001-p2", "role": "expert", "name": "陈安全", "title": "网络安全专家",
             "stance": "谨慎支持——开源促进安全审计，但需建立标准", "color": "#818CF8", "status": "idle",
    ...
    },
    {
        ...
        "panelists": [
            ...
            {"id": "seed-002-p2", "role": "expert", "name": "周管理", "title": "组织行为学教授",
             "stance": "混合制是归宿——远程与线下各有不可替代的价值", "color": "#818CF8", "status": "silent",
    ...
    },
    {
        ...
        "panelists": [
            ...
            {"id": "seed-003-p2", "role": "expert", "name": "郑自由", "title": "消费者权益律师",
             "stance": "反对强制限制——购车是个人自由，应改善公共交通而非限制私家车", "color": "#818CF8", "status": "idle",
    ...
    },
    {
        ...
        "panelists": [
            ...
            {"id": "seed-004-p2", "role": "expert", "name": "吕家长", "title": "家长代表、营养学博士",
             "stance": "反对——新鲜食材对儿童发育不可替代，营养流失是核心问题", "color": "#818CF8", "status": "idle",
    ...
    },
    {
        ...
        "panelists": [
            ...
            {"id": "seed-005-p2", "role": "expert", "name": "教书育", "title": "资深中学教师",
             "stance": "教育的本质是人与人的连接——AI可辅助但无法替代", "color": "#818CF8", "status": "idle",
    ...
    },
    {
        ...
        "panelists": [
            ...
            {"id": "seed-006-p2", "role": "expert", "name": "李地球", "title": "气候科学家",
             "stance": "反对——应优先投资地球生态修复而非太空殖民", "color": "#818CF8", "status": "idle",
             "public_focus": json.dumps([]), "sort_order": 2},
